package com.herbnation.entities;
...
public class Product {
	...
	@Column(length = 10000, name = "product_price")
	private int productPrice;
	
	@Column(length = 10000, name = "product_discount")
	private int productDiscount;
	
	@Column(length = 1000, name = "product_quantity")
	private int productQuantity;
	
	@Column(length = 1000, name = "product_availablity")
	...
	public Product(int productId, String productName, String productDescription, String productPhoto, int productPrice,
			int productDiscount, int productQuantity, String productAvailablity , Category category) {
		super();
	...
	public String isProductAvailablity() {
	...
	public String toString() {
		return "Product [productId=" + productId + ", productName=" + productName + ", productDescription="
				...
				+ ", productAvailablity=" + productAvailablity + "]";
	}
